...
const AssistantPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-w-4xl mx-auto max-h-[70vh]">
      {/* Header */}
      ...
      {/* Chat Box */}
      <div className="flex-1 min-h-[60vh] mt-4 flex flex-col rounded-2xl border bg-white shadow-sm dark:bg-gray-900 dark:border-gray-700">
